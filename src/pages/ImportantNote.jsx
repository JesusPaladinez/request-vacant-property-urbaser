...
export default function ImportantNote() {
  ...
  return (
    <div className='bg-urbaser-1 flex-1 flex flex-col justify-center items-center gap-10'>
      ...
      <p className='font-medium text-white text-lg'>Si tiene alguna queja, sugerencia o reclamo lo puede hacer a tráves de un PQR dando <a href="https://sispo.syspotec.co:8443/sispaseo/f?p=117:1:103536580903700:::::" target='_blank' rel='noopener noreferrer' className='underline hover:text-urbaser-2'>clic aquí</a>.</p>
