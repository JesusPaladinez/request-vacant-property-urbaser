  ...
  return (
    <footer className={`bg-urbaser-1 flex justify-around items-center p-4`}>
      ...
      <ul className='flex flex-col gap-4 text-white p-4'>
        ...
        <li><a href="https://wa.me/573112403041" target='_blank' rel='noopener noreferrer' className='hover:text-urbaser-2 flex items-center gap-x-2'><ImPhone className='text-urbaser-2 hover:text-white text-base' />Llamadas y WhatsApp: <span className='font-medium'>311 240 3041</span></a></li>
      </ul>
    </footer>
  )
}
